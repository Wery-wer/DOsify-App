...
class _HomePageState extends State<HomePage> {
  ...
  List<String> data = [
    ...
    "Music",
    "Task"
  ]; // template grid view builder di awal
  List<String> _tasks = [];
                ...
                ..._tasks
                    .map((task) => Row(
                          children: [
                            Checkbox(
                              value:
                                  true, // Atur nilai checkbox sesuai dengan keadaan tugas
                              onChanged: (newValue) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                          ...
                          child: Theme(
                            data: ThemeData(
                              ...
                              colorScheme: ColorScheme.light(
                                  primary: Color.fromARGB(255, 252, 71, 0)),
                ...
                child: Padding(
                  ...
                  child: GridView.builder(
                      ...
                      itemBuilder: (_, index) {
                        ...
                        String randomLogoFileName =
                            logoFileNames[random.nextInt(logoFileNames.length)];
                        String logoAssetPath =
                            'assets/logo/$randomLogoFileName';
      ...
      floatingActionButtonLocation: FloatingActionButtonLocation
          .endFloat, // Letakkan tombol di bawah kiri
    );
  }
}
